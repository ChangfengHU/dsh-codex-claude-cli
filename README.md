...
```sh
dsh plugin --profile web add dsh-codex-claude-cli@latest
...
```sh
dsh plugin --profile web add ./dist/dsh-codex-claude-cli-<version>.tgz
dsh --profile web --dump-config
dsh --profile web
```
...
```sh
dsh plugin --profile web add github:ChangfengHU/dsh-codex-claude-cli
```
...
```sh
dsh plugin --profile web remove dsh-codex-claude-cli
```
